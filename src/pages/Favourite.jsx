...
const Favourite = () => {
  ...
  let [alldata, setdata] = useState(() => {
    ...
    return deta.filter(
      (elem, idx, arr) => idx === arr.findIndex((data) => data.id === elem.id),
    );
  });
      ...
      <div className="flex flex-wrap justify-center p-4 gap-4">
        {alldata.map((data, idx) => {
          return (
            <div
              key={data.id}
              className="boxb shadow shadow-violet-600 w-full flex flex-col md:w-fit   md:flex-wrap   p-2 rounded-2xl"
            >
              <div className="flex py-2 px-6 items-center gap-4 justify-between">
                ...
                <div className="flex justify-center items-center bg-gray-800 h-20 w-60 p-2 rounded-md">
              ...
              <div className="flex gap-6 sm:mt-8 md:mt-2 justify-center items-center">
                <button
                  onClick={() => {
